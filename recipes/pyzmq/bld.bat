...
:: For now, we build pyzmq with the bundled zeromq. There were a number of reasons for
...
:: Remove asyncio on py2.  Alternative: require Trollius (https://pypi.python.org/pypi/trollius)
if %ANA_PY% == 27 (
